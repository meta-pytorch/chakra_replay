...
et_test_files = [
    ...
    # pt2_et.json.tar.gz is placed last because running it first can cause
    # other tests to become very slow
    "pt2_et.json.tar.gz",
]
